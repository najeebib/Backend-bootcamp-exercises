...
def get_matchups(players,rounds_num, matches_per_round):
    ...
    return matchups
# calculate the odds of winning based on player elo
def odds_of_winning(player1, player2):
    ...
    return player1_odds
# calculate teh elo after game based on the odds
def calculate_elo(player1, player2):
    player1_elo = player1["elo"]
    player2_elo = player2["elo"]
    # the elo value is between 0 and 20
    # the higher the odds of winning the less elo the player will get and vice versa
